"""Freeroute - helps find safe routes, provides maps + locational analysis

API site: https://freeroute.org/
API docs: https://api.maps.freeroute.org/
...
class FreerouteScraper(BaseScraper):
    source_name = "freeroute"
